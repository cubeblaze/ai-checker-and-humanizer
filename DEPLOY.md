...
> If you already generated a key and pasted it somewhere it could be logged or
> seen by someone else (a chat, a doc, a screen share), delete it from AI
> Studio and generate a fresh one before using it below — treat any key that's
> left your own terminal as compromised.
...
```bash
wrangler deploy worker.js --name klarity-ai-backend --compatibility-date 2026-01-01
